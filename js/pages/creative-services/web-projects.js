...
const WP_PROJECTS = {
  'web-portfolio': {
    ...
    year:    '2025',
    status:  'Live',
    github:  'https://github.com/alexmorganrivera-cell/Website-Portfolio',
  ...
  'web-pcu-global-intl': {
    title:   'NGU Global — International Office Website',
    tagline: "Rebuilding an institutional web presence for a university's international office.",
    year:    '2026',
    status:  'In Progress',
    github:  'https://github.com/alexmorganrivera-cell/International-Office-Website',
    live:    'https://international-office-website.vercel.app/',
    tech:    ['HTML', 'CSS', 'JavaScript', 'Tailwind CSS', 'Supabase'],
    background: `Northgate University's International Office had a digital presence that had not kept pace with its growing partnerships and ambitions. The old site was a static collection of pages with no content management, inconsistent design, and poor information architecture that made it hard for prospective partner universities and exchange students to find what they needed. The brief was clear: rebuild from scratch, with a content system that staff could maintain themselves, a design that reflected NGU's positioning as an internationally recognised institution, and a structure that served both inbound and outbound audiences.`,
    features: [
      { icon: 'globe',        title: 'Inbound & Outbound Programs', desc: 'Dedicated pages for every academic program — semester exchange, international degree, ICOP, American SPECTRUM, joint/double degree, and internship — structured around two distinct audience journeys.' },
      ...
      { icon: 'map',          title: 'Interactive Partnership Directory', desc: 'A drill-down modal — continent → country → partner details — lets visitors explore NGU\'s global network. Domestic partners have a separate categorised modal with toggleable sections.' },
    ...
    problems: [
      ...
      },
      {
        ...
        desc: "NGU's network of international partners had no visual representation — no searchable directory, no map, no snapshot of the institution's global reach.",
      },
      {
        icon: 'smartphone',
  ...
  'web-dashboard-grants': {
    ...
    year:    '2025',
    status:  'Live',
    github:  'https://github.com/alexmorganrivera-cell/Dashboard-International-Grants',
