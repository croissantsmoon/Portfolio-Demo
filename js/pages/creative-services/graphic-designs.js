...
const GD_PROJECTS = [
  {
    ...
    title: 'NGU Partnership Booklet',
    fullTitle: 'Partnership Initiative Booklet for Northgate University',
    ...
    summary: 'A comprehensive booklet showcasing NGU\'s international partnership initiatives — designed to attract new institutional partners and communicate the depth of existing collaborations.',
    ...
    approach: 'Used NGU\'s brand language as a foundation, then elevated it with premium editorial layouts, rich data storytelling, and clear visual hierarchy.',
    ...
    impact: 'Used by NGU International Office in partner meetings and institutional visits across Southeast Asia and beyond.',
  ...
  },
  {
    ...
    title: 'NGU International Students Guide',
    fullTitle: 'International Students Guidebook for Northgate University',
    institution: 'Northgate University',
    year: '2024–2025',
    ...
    summary: 'A comprehensive guidebook helping international students navigate life at NGU — from academic processes to daily living in Portland.',
    ...
    impact: 'Distributed to all incoming international students at NGU as their primary orientation resource.',
  ...
  {
    id: 'pcu-presentation',
    title: 'NGU Presentation Template',
    fullTitle: 'General Presentation Template for Partnership Initiative — Northgate University',
    institution: 'Northgate University',
    year: '2024–2025',
    ...
    summary: 'A modular, reusable presentation template giving NGU\'s international partnership team a consistent, polished voice in every meeting, pitch, and partner visit.',
    challenge: 'Creating a template flexible enough for MoU meetings, partner visits, and conferences — while keeping every slide unmistakably NGU.',
    ...
    impact: 'Now the standard presentation template for all NGU International Office partner meetings and official conferences.',
  ...
  },
  {
    ...
    fullTitle: 'Guidebook for Westbridge Cultural Immersion 2025 — Batch 2',
    ...
    summary: 'A concise, high-impact guidebook for international students joining the Westbridge Cultural Immersion program — every page designed to make participants feel welcomed, informed, and genuinely excited.',
  ...
  },
  {
    ...
    fullTitle: 'Guidebook for Westbridge Cultural Immersion 2025 — Batch 1',
    institution: 'Westbridge University',
    year: '2025',
    categories: ['guidebook', 'student'],
    emoji: '🌿',
    ...
    pages: 15,
    skills: ['Graphic Design', 'Editorial Layout', 'Information Architecture', 'Communication Design'],
    summary: 'The inaugural guidebook for ACI 2025\'s first batch — setting the visual identity and design system for the entire Westbridge Cultural Immersion series.',
  ...
  },
  {
    ...
    title: 'Staffordshire × Coastal Program Booklet',
    fullTitle: 'Booklet for Staffordshire University Tailor-Made Program to the Pacific Coast',
    institution: 'Staffordshire University × Westbridge University',
    year: '2025',
    categories: ['institutional', 'partnership'],
    emoji: '✦',
    ...
    summary: 'A tailor-made program booklet for Staffordshire University students visiting the Pacific Coast — blending academic immersion with cultural exploration in a visually distinctive editorial format.',
    challenge: 'Designing for a brand-new partnership with no established visual identity — while making both Staffordshire and Westbridge feel equally represented and proud.',
    approach: 'Created a warm, exploratory visual language drawn from Oregon\'s natural landscape — earth tones, organic shapes, and editorial magazine-style layouts.',
    ...
    designDecisions: [
      { icon: '◈', label: 'Neutral Dual-brand', text: 'A visual language neither institution fully "owns" — warm earth tones feel American without alienating the UK partner delegation.' },
      { icon: '✦', label: 'Destination Storytelling', text: 'The Pacific Coast\'s natural beauty became the visual metaphor — organic shapes and rich textures made the program feel like an adventure, not just an exchange.' },
  ...
  },
  {
    ...
    summary: 'A flagship institutional presentation for AERO 2025 — communicating Westbridge University\'s global partnerships to an international audience of institutional leaders.',
    ...
    impact: 'Presented live at AERO 2025 to institutional partners from across Asia and Europe — representing Westbridge University on an international stage.',
    deliverables: ['13-slide institutional deck', 'Partnership achievement data slides', 'Program overview spreads', 'Westbridge-branded opening & closing'],
    designDecisions: [
  ...
  },
  {
    ...
    title: 'Westbridge Accommodation Booklet',
    fullTitle: 'Accommodation Booklet for Westbridge University International Students',
    institution: 'Westbridge University',
    year: '2024–2025',
    categories: ['guidebook', 'student'],
    emoji: '🏠',
    ...
    pages: 28,
    skills: ['Graphic Design', 'Information Architecture', 'Communication Design', 'International Education'],
    summary: 'A dedicated accommodation guide for international students at Westbridge University — covering housing options, neighborhoods, costs, and practical tips for settling into Portland.',
    ...
    impact: 'Distributed digitally to all incoming international students at Westbridge University one month before their arrival date.',
    ...
    designDecisions: [
      { icon: '◈', label: 'Map-centric Navigation', text: 'Every neighborhood profile is anchored by a spatial reference — giving students a mental map of Portland before they land.' },
  ...
  },
  {
    ...
    title: 'Westbridge International Students Guide',
    fullTitle: 'International Students Guidebook for Westbridge University',
    institution: 'Westbridge University',
    year: '2024–2025',
    categories: ['guidebook', 'student'],
    emoji: '⬡',
    ...
    pages: 32,
    skills: ['Graphic Design', 'Editorial Layout', 'Information Architecture', 'Communication Design'],
    summary: 'The comprehensive international student handbook for Westbridge University — covering everything from enrollment to campus life for students arriving from around the world.',
    ...
    impact: 'The primary onboarding resource for international students — and the most downloaded student document on Westbridge University\'s international office portal.',
    deliverables: ['32-page comprehensive handbook', 'Five-chapter navigation system', 'Portland city guide section', 'Academic calendar & support directory'],
    designDecisions: [
...
const GD_INSPO = [
  ...
  'American culture', 'Travel design', 'Institutional print',
  ...
  return `
    ...
    ">
      <div style="position:relative;overflow:hidden;height:185px;background:#071126">
        <img src="https://picsum.photos/seed/${p.folder}-1/800/600" alt="${p.title}"
          class="gd-cover-img"
    ...
    contentHTML = `
      ...
      ">
        ...
        <div style="position:relative;overflow:hidden;min-height:240px;background:#071126">
          <img src="https://picsum.photos/seed/${featured.folder}-1/800/600"
            alt="${featured.title}"
    ...
    <div style="
      ...
      <div class="max-w-3xl mx-auto text-center gd-reveal" style="position:relative;z-index:1">
        ...
        <div style="display:flex;flex-wrap:wrap;gap:14px;justify-content:center;align-items:center">
          ...
          <a href="mailto:alex.morgan@example.com" style="
...
function gdLightboxContent() {
  ...
  const thumbs = Array.from({ length: total }, (_, i) => `
    ...
    " onmouseover="this.style.opacity='0.8'" onmouseout="this.style.opacity='${i === gdLightboxIndex ? '1' : '0.4'}'">
      <img src="https://picsum.photos/seed/${p.folder}-${i+1}/800/600" style="width:100%;height:100%;object-fit:cover;object-position:top" loading="lazy">
    </div>`).join('');
  ...
  return `
    ...
    <div style="position:relative;z-index:2;display:flex;align-items:center;justify-content:center;width:100%;padding:56px 80px 80px">
      <img loading="lazy" id="gd-lb-img" src="https://picsum.photos/seed/${p.folder}-${n}/800/600"
           alt="${p.title} — page ${n}"
...
function gdBuildImageGallery(project) {
  ...
  const imgs = Array.from({ length: previewCount }, (_, i) => i + 1).map(n => `
    ...
    " onmouseover="this.style.transform='translateY(-5px) scale(1.02)';this.style.boxShadow='0 16px 40px rgba(3,7,18,0.65)'"
      ...
      <img src="https://picsum.photos/seed/${project.folder}-${n}/800/600"
      ...
      <div class="max-w-5xl mx-auto" style="padding:clamp(3rem,6vh,5rem) 24px">
        ...
        <div style="border-radius:24px;overflow:hidden;margin-bottom:3.5rem;
          ...
          <div onclick="gdOpenLightbox('${project.id}', 0)" style="height:220px;overflow:hidden;position:relative;cursor:zoom-in">
            <img src="https://picsum.photos/seed/${project.folder}-1/800/600"
