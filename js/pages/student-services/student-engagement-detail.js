  ...
  el.innerHTML = `
     ...
     <div style="padding:72px 24px 72px;background:#FAFAF8">
      ...
      <div class="mb-20">
       ...
       <p class="text-base max-w-3xl mb-10" style="color:#5C5C5C">From city explorations and traditional art shows to community volunteering and peer friendship programs — each activity was designed to deepen students' connection with Indonesian culture, people, and ways of life. Click on any card to learn more.</p>
       <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        <div class="card rounded-2xl overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1 cursor-pointer" onclick="openEngagementModal('city-tour')" style="border:1px solid rgba(28,28,30,0.08)">
         ...
         <div class="p-6">
          ...
          <h3 class="font-heading font-semibold text-lg mb-2" style="color:#1C1C1E">Surabaya City Tour</h3>
          <p class="text-sm mb-4 leading-relaxed" style="color:#5C5C5C">Guided explorations of Surabaya's historical landmarks, cultural sites, and local neighborhoods — helping students discover their host city's identity and character.</p>
        ...
        <div class="card rounded-2xl overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1 cursor-pointer" onclick="openEngagementModal('rujak-uleg')" style="border:1px solid rgba(28,28,30,0.08)">
         ...
         <div class="p-6">
          ...
          <p class="text-sm mb-4 leading-relaxed" style="color:#5C5C5C">Immersive participation in Surabaya's iconic annual culinary festival — experiencing local food culture, community traditions, and authentic Indonesian celebration.</p>
        ...
        <div class="card rounded-2xl overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1 cursor-pointer" onclick="openEngagementModal('tari-topeng')" style="border:1px solid rgba(28,28,30,0.08)">
         ...
         <div class="p-6">
          ...
          <p class="text-sm mb-4 leading-relaxed" style="color:#5C5C5C">A cultural excursion to Malang to witness one of East Java's most revered traditional performing arts — deepening appreciation for Indonesia's rich artistic heritage.</p>
        ...
        <div class="card rounded-2xl overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1 cursor-pointer" onclick="openEngagementModal('volunteering')" style="border:1px solid rgba(28,28,30,0.08)">
         ...
         <div class="p-6">
          ...
          <p class="text-sm mb-3 leading-relaxed" style="color:#5C5C5C">Community engagement creating genuine educational exchange and social impact across partner institutions in Surabaya and beyond.</p>
