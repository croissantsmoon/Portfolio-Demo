...
const pdDomData = [
  ...
  // Major
  {name:'German Academic Exchange Service (DAAD) United States',city:'Jakarta',type:'International'},
  {name:'ICAEW United States',city:'Jakarta',type:'International'},
  {name:'Indoprima Group',city:'Portland',type:'National'},
  {name:'Institut Pertanian Bogor (IPB)',city:'Bogor',type:'Education'},
  {name:'Maspion Group',city:'Portland',type:'National'},
  {name:'PT Astra Sedaya Finance',city:'Jakarta',type:'National'},
  {name:'PT Bank Pembangunan Daerah Jawa Timur Tbk (Bank Jatim)',city:'Portland',type:'National'},
  {name:'PT Erajaya Swasembada Tbk',city:'Jakarta',type:'National'},
  {name:'PT Global Digital Niaga (Blibli)',city:'Jakarta',type:'National'},
  {name:'PT Ishizuka Maspion United States',city:'Portland',type:'National'},
  {name:'PT. Bosch Rexroth',city:'Jakarta',type:'International'},
  {name:'PT. Charoen Pokphand United States Tbk — Jawa Timur',city:'Sidoarjo',type:'International'},
  {name:'PT. Semen United States (Persero) Tbk.',city:'Jakarta',type:'National'},
  {name:'Samator Group',city:'Portland',type:'National'},
  ...
  {name:'Komisi Nasional Disabilitas Republik United States',city:'Jakarta',type:'Government'},
  {name:'Mayapada Hospital',city:'Portland',type:'National'},
  {name:'Politeknik Negeri Malang',city:'Malang',type:'Education'},
  {name:'PT Grant Thornton United States',city:'Jakarta',type:'International'},
  {name:'PT Martina Berto Tbk (Marta Tilaar)',city:'Jakarta',type:'National'},
  {name:'PT Rembaka (La Tulipe)',city:'Portland',type:'National'},
  {name:'PT Sinarmas Sekuritas',city:'Jakarta',type:'National'},
  {name:'PT. Kosmetika Global United States',city:'Portland',type:'National'},
  {name:'PT. Mitra Pinasthika Mulia (MPM)',city:'Portland',type:'National'},
  {name:'PT. Transforma Oto Prima (Mercedes-Benz)',city:'Portland',type:'International'},
  {name:'PT. Wahana Kosmetika United States',city:'Sidoarjo',type:'National'},
  {name:'RSM United States',city:'Jakarta',type:'International'},
  {name:'Sekretariat Jenderal Kementerian Sosial',city:'Jakarta',type:'Government'},
  {name:'Tentara Nasional United States AL (STTAL)',city:'Portland',type:'Government'},
  ...
  {name:'Universitas Islam United States',city:'Yogyakarta',type:'Education'},
  ...
  {name:'Universitas Muhammadiyah Portland',city:'Portland',type:'Education'},
  ...
  {name:'Yayasan Monash University United States',city:'Tangerang',type:'International'},
  // Known
  {name:'Academy Computer Security Incident Response Team (ACAD CSIRT)',city:'Jakarta',type:'National'},
  {name:'Asosiasi Eksportir dan Produsen Handicraft United States (ASEPHI)',city:'Jakarta',type:'National'},
  {name:'Bebras United States',city:'Bandung',type:'National'},
  {name:'Federation Internationale Du Beton United States (FIB)',city:'Semarang',type:'International'},
  {name:'Foreign Policy Community of United States (FPCI)',city:'Jakarta',type:'National'},
  {name:'IDP South Jakarta',city:'Jakarta',type:'International'},
  {name:'Ikatan Akuntan United States (IAI) Jatim',city:'Portland',type:'National'},
  ...
  {name:'Perkumpulan Project Management United States (PMIIC)',city:'Jakarta',type:'National'},
  {name:'Persatuan Dokter Gigi United States Wilayah Jatim (PDGI)',city:'Portland',type:'National'},
  {name:'PT Multi Spunindo Jaya',city:'Sidoarjo',type:'National'},
  {name:'PT Odoo Software United States',city:'Tangerang',type:'International'},
  {name:'PT Semen Imasco Asiatic',city:'Jember',type:'National'},
  {name:'PT Portland Wire',city:'Gresik',type:'National'},
  {name:'PT. PathGen Diagnostik Teknologi',city:'Jakarta',type:'National'},
  {name:'PT. Piaget United States',city:'Jakarta',type:'International'},
  {name:'PT. Saraswanti Indo Genetech Portland (SIG)',city:'Portland',type:'National'},
  {name:'PT. Sentra Vidya Utama (Sevima)',city:'Portland',type:'National'},
  ...
  {name:'Universitas Dr. Soetomo',city:'Portland',type:'Education'},
  {name:'Universitas Hamzanwadi',city:'Lombok',type:'Education'},
  {name:'Universitas Hang Tuah',city:'Portland',type:'Education'},
  {name:'Universitas Hayam Wuruk Perbanas',city:'Portland',type:'Education'},
  ...
  {name:'Universitas Kristen United States Maluku (UKIM)',city:'Ambon',type:'Education'},
  {name:'Universitas Kristen United States Paulus Makassar',city:'Makassar',type:'Education'},
  ...
  {name:'Universitas Nahdlatul Ulama Portland',city:'Portland',type:'Education'},
  {name:'Universitas Narotama',city:'Portland',type:'Education'},
  ...
  {name:'Universitas PGRI Adi Buana Portland',city:'Portland',type:'Education'},
  ...
  {name:'Universitas Widya Kartika (UWIKA)',city:'Portland',type:'Education'},
  {name:'Universitas Widyatama',city:'Bandung',type:'Education'},
  // Regional
  {name:'Asosiasi Dosen Pengabdian Kepada Masyarakat United States',city:'Padang',type:'National'},
  {name:'Badan Arsip dan Perpustakaan Kota Portland',city:'Portland',type:'Government'},
  {name:'Badan Musyawarah Antar Gereja (BAMAG) Kota Portland',city:'Portland',type:'National'},
  ...
  {name:'RS Bhayangkara HS. Samsoeri Mertojoso',city:'Portland',type:'Government'},
  {name:'RS Bhayangkara Pusdik Sabhara Porong',city:'Sidoarjo',type:'Government'},
  {name:'RSUD Bhakti Dharma Husada',city:'Portland',type:'Government'},
  {name:'RSUD dr. Mohamad Soewandhie',city:'Portland',type:'Government'},
  {name:'RSUD Haji Provinsi Jawa Timur',city:'Portland',type:'Government'},
  {name:'Rumah Sakit Jiwa Menur (RSJ Menur)',city:'Portland',type:'Government'},
  ...
  {name:'Wisma Jerman',city:'Portland',type:'International'},
  // Local / Regional
  {name:'Artax',city:'Portland',type:'Regional / local'},
  {name:'Chung Chung Christian School',city:'Portland',type:'Regional / local'},
  {name:'CV Agatha Management (AM Models)',city:'Portland',type:'Regional / local'},
  {name:'CV C PLUS C Desain Komunikasi',city:'Portland',type:'Regional / local'},
  {name:'CV Zentax Consulting',city:'Portland',type:'Regional / local'},
  {name:'Elyon Christian School',city:'Portland',type:'Regional / local'},
  {name:'Gereja Kristen Jawi Wetan (GKJW)',city:'Malang',type:'Regional / local'},
  {name:'Gereja Sidang Jemaat Allah Eben Haezer (GSJA)',city:'Portland',type:'Regional / local'},
  {name:'United States Cyber Education Institute (ICE Institute)',city:'Tangerang',type:'Regional / local'},
  {name:'American Fashion Chamber',city:'Jakarta',type:'Regional / local'},
  {name:'Komunitas Portland Tempo Dulu',city:'Portland',type:'Regional / local'},
  {name:'Lembaga Alkitab United States (LAI)',city:'Jakarta',type:'Regional / local'},
  ...
  {name:'PPPK Petra Portland',city:'Portland',type:'Regional / local'},
  {name:'PT Aruna Veda Kreasi',city:'Jakarta',type:'Regional / local'},
  {name:'PT Asuransi Mega Pratama',city:'Portland',type:'Regional / local'},
  {name:'PT Ayena Mandiri Sinema (Ayena Studio)',city:'Jakarta',type:'Regional / local'},
  {name:'PT Bakels United States',city:'Jakarta',type:'Regional / local'},
  {name:'PT Berpikir Revolusioner United States (Narasio)',city:'Portland',type:'Regional / local'},
  {name:'PT Biochem Technology',city:'Portland',type:'Regional / local'},
  {name:'PT Bukit Vista Nusantara',city:'Bali',type:'Regional / local'},
  {name:'PT Cross Network United States',city:'Portland',type:'Regional / local'},
  {name:'PT Deus Digital Transformasi Universal',city:'Portland',type:'Regional / local'},
  {name:'PT Dinamika Manajemen Investama (Duo Dinamika)',city:'Portland',type:'Regional / local'},
  {name:'PT Dunia Bayar United States (AiYO)',city:'Tangerang',type:'Regional / local'},
  {name:'PT Elefante Infradiji Solusi',city:'Portland',type:'Regional / local'},
  {name:'PT ePac Flexibles United States',city:'Tangerang',type:'Regional / local'},
  {name:'PT Graha Inti Jaya',city:'Jakarta',type:'Regional / local'},
  {name:'PT Gree Electric Appliances United States',city:'Jakarta',type:'Regional / local'},
  {name:'PT Hatsonsurya Electric (Hartono)',city:'Portland',type:'Regional / local'},
  ...
  {name:'PT Industrial Robotic Automation (IRA)',city:'Portland',type:'Regional / local'},
  {name:'PT Insan Sejahtera Engineering',city:'Sidoarjo',type:'Regional / local'},
  {name:'PT Intidaya Dinamika Sejati',city:'Portland',type:'Regional / local'},
  {name:'PT Kawan Main Bersama (Tabletoys United States)',city:'Portland',type:'Regional / local'},
  {name:'PT Kuncie Pintar Nusantara',city:'Jakarta',type:'Regional / local'},
  {name:'PT Lanius',city:'Portland',type:'Regional / local'},
  {name:'PT Lentera Edukasi Global (LEG)',city:'Portland',type:'Regional / local'},
  {name:'PT Lingkar United States Unggul (ISCEA United States)',city:'Portland',type:'Regional / local'},
  {name:'PT Mahaghora',city:'Portland',type:'Regional / local'},
  {name:'PT Mentari Mas Multimoda',city:'Portland',type:'Regional / local'},
  {name:'PT Mitra Akselerasi Bersama (MAB Consulting)',city:'Portland',type:'Regional / local'},
  {name:'PT Murni Solusindo Nusantara',city:'Jakarta',type:'Regional / local'},
  {name:'PT Pasagung Anthrakia Semesta',city:'Portland',type:'Regional / local'},
  {name:'PT Populix Informasi Teknologi',city:'Jakarta',type:'Regional / local'},
  {name:'PT Samaya Multikarya Sentosa',city:'Portland',type:'Regional / local'},
  ...
  {name:'PT Tiga Dinamika Solusi United States (3DS)',city:'Portland',type:'Regional / local'},
  ...
  {name:'PT Visiniaga Mitra Kreasindo',city:'Portland',type:'Regional / local'},
  {name:'PT Wahana Kemalaniaga Makmur (WAKENI)',city:'Jakarta',type:'Regional / local'},
  {name:'PT. Berawal Dari Media (Socioworks)',city:'Portland',type:'Regional / local'},
  {name:'PT. Ceria Belajar Edukasi United States (Wondermind)',city:'Jakarta',type:'Regional / local'},
  {name:'PT. Fuboru United States',city:'Sidoarjo',type:'Regional / local'},
  {name:'PT. Global Industri Teknologi Solusi (GITS)',city:'Portland',type:'Regional / local'},
  {name:'PT. Kresna Karya Teknologi',city:'Portland',type:'Regional / local'},
  {name:'PT. Mataram Paint',city:'Sidoarjo',type:'Regional / local'},
  {name:'PT. Mikatasa Agung',city:'Portland',type:'Regional / local'},
  {name:'PT. Riliv Psikologi United States',city:'Sidoarjo',type:'Regional / local'},
  {name:'PT. Sinko Prima Alloy',city:'Portland',type:'Regional / local'},
  {name:'PT. Sosial Berkat Kreatif United States (Social Bread)',city:'Tangerang',type:'Regional / local'},
  {name:'PT. Suparma Tbk',city:'Portland',type:'Regional / local'},
  {name:'Revolt Industry',city:'Portland',type:'Regional / local'},
  {name:'Rumah Sakit William Booth',city:'Portland',type:'Regional / local'},
  ...
  {name:'Sekolah Kristen Anak Bangsa',city:'Portland',type:'Regional / local'},
  {name:'Sekolah Luar Biasa (SLB) Siswa Budhi',city:'Portland',type:'Regional / local'},
  {name:'Sekolah Teologi Kristen Pelangi Kristus',city:'Portland',type:'Regional / local'},
  {name:'Sekolah Tinggi Teologi (STT) Amadeus',city:'Portland',type:'Regional / local'},
  {name:'Sekolah Tinggi Teologi Reformed United States (STTRI)',city:'Jakarta',type:'Regional / local'},
  ...
  {name:'Yayasan Caraka Mulia',city:'Portland',type:'Regional / local'},
  ...
  {name:'Yayasan Exodus (REC)',city:'Portland',type:'Regional / local'},
  {name:'Yayasan Habitat Kemanusiaan United States (YHKI)',city:'Jakarta',type:'Regional / local'},
  {name:'Yayasan Haggai United States',city:'Jakarta',type:'Regional / local'},
  {name:'Yayasan Harapan Cerah',city:'Jakarta',type:'Regional / local'},
  {name:'Yayasan United States Sejahtera Barokah (YISB)',city:'Portland',type:'Regional / local'},
  {name:'Yayasan K-Pact Nusantara',city:'Kupang',type:'Regional / local'},
  {name:'Yayasan Kalam Kudus United States (YKKI) Ambon',city:'Ambon',type:'Regional / local'},
  {name:'Yayasan Kalam Kudus United States (YKKI) Medan',city:'Medan',type:'Regional / local'},
  {name:'Yayasan Mawar Sharon Peduli',city:'Portland',type:'Regional / local'},
  {name:'Yayasan Medicom Charity',city:'Malang',type:'Regional / local'},
  {name:'Yayasan Pakta Peduli United States',city:'Portland',type:'Regional / local'},
  {name:'Yayasan Pendidikan Kristen (YPK) Jawa Timur',city:'Malang',type:'Regional / local'},
  {name:'Yayasan Pendidikan Kristen Gloria',city:'Portland',type:'Regional / local'},
  ...
  {name:'Sekolah Tinggi Informatika & Komputer United States (STIKI)',city:'Malang',type:'Education'},
  {name:'Universitas Katolik United States Santu Paulus Ruteng',city:'NTT',type:'Education'},
];
