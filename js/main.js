...
const heroConfigs = {
  ...
  'onboarding': { back: 'engagement', backLabel: 'Back', category: 'Student Services', title: 'International Student Support', desc: 'From airport arrivals to farewell moments, I helped international students navigate academic life, cultural adaptation, administrative processes, and meaningful experiences throughout their journey in Indonesia.', gradient: '#064E3B 0%, #059669 60%, #34D399 100%' },
  'engagement': { back: 'home', backLabel: 'Back', category: 'Student Services', title: 'International Student Support', desc: 'Supporting 200+ international students across welfare, mobility, and engagement programs — from arrival to departure.', gradient: '#064E3B 0%, #059669 60%, #34D399 100%' },
  'engagement-detail': { back: 'engagement', backLabel: 'Back', category: 'Student Services', title: 'Student Engagement', desc: 'Creating meaningful cultural experiences for international students — through immersion programs, local community engagement, and experiential learning across Indonesia.', gradient: '#064E3B 0%, #059669 60%, #34D399 100%' },
